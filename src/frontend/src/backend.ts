...
export class Backend implements backendInterface {
    ...
    async createGoal(arg0: string, arg1: string): Promise<Goal> {
        if (this.processError) {
            try {
    ...
    async createHabit(arg0: string): Promise<HabitView> {
        if (this.processError) {
            try {
    ...
    async getHabitCompletionLog(arg0: bigint): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getHabitCompletionLog(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markHabitComplete(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateGoal(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateHabit(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
